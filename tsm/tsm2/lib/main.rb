...
class TSM2
    ...
    def initialize()        
        #Configure
        @root_container = "c:\\servers"
        @client_container = "c:\\workspaces"
    ...
    def parse_opts()
        ...
        @options[:port] = "20102"
        @options[:i18n] = false
        @options[:root] = "#{@root_container}/#{@options[:version]}"
        ...
        OptionParser.new do |opts|
            opts.banner = "Usage: tsm.rb [options] -v <UNDELEMITED_VERSION>"
